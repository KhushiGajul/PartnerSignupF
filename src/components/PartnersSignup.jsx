...
const PartnersSignup = () => {
    ...
    const getUserRegister = async (data) => {
        try {
            ...
            const response = await axios.post("http://3.109.152.74:5000/api/partners/register", payload, AUTH_CONFIG);
    ...
    const getPan = async (data) => {
        try {
            ...
            await axios.put(`http://3.109.152.74:5000/api/partners/update/${identifier}`, payload, AUTH_CONFIG);
